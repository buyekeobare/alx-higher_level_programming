#!/usr/bin/python3
"""
    This is a class Rectangle that implements Base.
"""
...
class Rectangle(Base):
    ...
    def width(self):
        """
            retriever function for __width
            Returns: width
        """
        return self.__width
...
#        print("{}".format(rectangle))
    ...
    def __str__(self):
        """
            returns a str formart of the class Rectangle
        """
    ...
    def to_dictionary(self):
        """
            returns the dictionary repr of a class Rect
        """
